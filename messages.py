...
START_TEXT_CAPTION_TEXT = "Hello dear💖, This is Sanila's Telegram Assistant bot™️\n\n" \
                          "◇───────────────◇\n\n" \
...
CREDITS_TEXT = "**Credits**\n\nThis bot was created by Sanila under **GNU General Public License v3.0**. Therefore changing the code is NOT ALLOWED TO YOU!!\n\n" \
               ...
               "You can check how version changes from <a href=https://github.com/sanila2007/Sanila-Assistant-Bot#changelog>here</a> and a comparison between oldest version vs latest version" \
               " from <a href=https://github.com/sanila2007/Sanila-Assistant-Bot#comparison-between-v01-vs-v06>here.</a>\n\n" \
               ...
               "very quickly. And don't forget to Star⭐ my projects and Fork🍴 those!" \
               "\n\nSpecial thanks to,\n" \
